  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "star-glow": "star-glow 2s ease-in-out infinite alternate",
      ...
      keyframes: {
        ...
        "star-glow": {
          "0%": {
            filter: "drop-shadow(0 0 10px hsl(var(--star-gold) / 0.3))",
          },
          "100%": {
            filter: "drop-shadow(0 0 20px hsl(var(--star-gold) / 0.6))",
          },
        },
        "copy-success": {
          "0%": {
